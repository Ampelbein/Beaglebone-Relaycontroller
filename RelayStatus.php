...
?>
	...
	<script>$(document).ready(function(){$("#headingLicht").click(function(){$("#groupLicht").toggle();});});</script>
	<script>$(document).ready(function(){$("#headingKlima").click(function(){$("#groupKlima").toggle();});});</script>
	<script>$(document).ready(function(){$("#headingTuer").click(function(){$("#groupTuer").toggle();});});</script>
	<script>$(document).ready(function(){$("#headingRollo").click(function(){$("#groupRollo").toggle();});});</script>

			<div id="headingLicht"><h2>Licht</h2></div>
			<div id="groupLicht">
			...
			<hr />
			<div id="headingKlima"><h2>Klimager&auml;te</h2></div>
			<div id="groupKlima">
				<div class="input-group btn-group">
			...
			<hr>
			<div id="headingTuer"><h2>T&uuml;r</h2></div>
			<div id="groupTuer">
				<div class="input-group btn-group">
			...
			<hr>
			<div id="headingRollo"><h2>Rollo</h2></div>
			<div id="groupRollo">
				<div class="input-group btn-group">
